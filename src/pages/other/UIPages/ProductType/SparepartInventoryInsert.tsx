    ...
    const fetchData = async () => {
      try {
        ...
        if (data.isSuccess && data.inventorySpares.length > 0) {
          const sparePart = data.inventorySpares[0]; // Assuming we are working with the first spare part from the list
          setFormData({
            ...
            manufacturing_Date: new Date().toISOString(), // or fetch from your API response
