...
const TaskMaster = () => {
    const [designations, setDesignations] = useState<TaskMaster[]>([]);
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (response.data.isSuccess) {
                setDesignations(response.data.taskMasterLists);
    ...
    const convertToCSV = (data: TaskMaster[]) => {
        const csvRows = [
            ['ID',
                'Task Name', 'Status',
        ...
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                ...
                <div className="d-flex justify-content-end  ">
                    ...
                    <Link to='/pages/TaskMasterinsert'>
                                                    ...
                                                    {columns.filter(col => col.visible).map((col) => (
                                                        ...
                                                        >
                                                            {col.id === 'status' ? (item.status === 1 ? 'Active' : 'Inactive') : (
                                                                <div>{item[col.id as keyof TaskMaster]}</div>
                                                            )}
                                                        </td>
                                                    ))}

                                                    <td><Link to={`/pages/TaskMasterinsert/${item.id}`}>
