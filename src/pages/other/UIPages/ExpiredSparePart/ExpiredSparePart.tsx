...
const ExpiredSparePart = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axiosInstance.get(`${config.API_URL}/InventorySpare/GetExpirySparePartList`, {
        ...
        <div className='p-3 mt-3 bg-white'>
           <Row className=' mb-2 px-2'>
                <div className="d-flex justify-content-between profilebar p-1">
                    <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i>Expired Spare Part List</h4>
            ...
            {loading ? (
                ...
                <>
                    <div className="overflow-auto text-nowrap">
                        {!inventorySpares || inventorySpares.length === 0 ? (
